...
<c:set var="active_page" value="Product.jsp" scope="session" />
<c:choose>
...
<html><head><title><fmt:message key="title_site"/></title>
        ...
        <link rel="stylesheet" type="text/css" href="style/main.css">
                    ...
                    <div id="hat_page">
                            <c:import url="Hat.jsp?lang=${lang}&parant=Cart.jsp"/>  
                    </div>
        </div>
               </div>      
                    </div>
                        ...
                        <div id="shopfilter">
                            ...
                            <ul class="menu-list" id="left-navigation">
                                <li class="left-navigation-item">
                                    <a class="left-link" href="http://localhost:8084/Febos2/ListOfProducts.jsp?lang=${lang}"><fmt:message key="left-navigation-item_0"/></a> 
                                </li>
                                <c:forEach var="i" begin="1" end="4">
                                    <li class="left-navigation-item">
                                        <a class="left-link" href="http://localhost:8084/Febos2/ListOfProducts.jsp?lang=${lang}&genre_filter=<fmt:message bundle="${en}" key="left-navigation-item_${i}"/>">
            ...
            <div id="buy_div">
                ...
                <a href="http://localhost:8084/Febos2/Cart.jsp?lang=${lang}">
                    <span class="button_next" onclick="buyButtonFuck(${idPicture});">
                        <fmt:message key="buy"/>
                    </span>
                </a>
            </div>
