...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="style/fonts/franklin-gothic-demi-cond.ttf">
        ...
        <div id="hat">      
            ...
            %>
                <a href="PersonalServlet?lang=<%=lang%>"><span><%=res.getString("header_0")%></span></a>
                 <a href="Cart.jsp?lang=<%=lang%>"><span><%=res.getString("header_1")%></span></a>
        ...
        <div id="fon_top_menu">
                    ...
                    <nav>
                        ...
                        <li class="navigation-bar-item">
                             <a class=navigerion-bar-link href="Main.jsp?lang=<%=lang%>">
                                 <span class=navigerion-bar-span><%=res.getString("navigation_menu_item_0")%></span>
                             </a>
                         </li>
                         <li class="navigation-bar-item">
                             <a class=navigerion-bar-link href="ListOfProducts.jsp?lang=<%=lang%>">
                                 <span class=navigerion-bar-span><%=res.getString("navigation_menu_item_1")%></span>
                             </a>
                         </li>
                         </ul>
                    </nav>
