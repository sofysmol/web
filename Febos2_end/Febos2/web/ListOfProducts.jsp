        ...
        <div id="main_conteiner">
           <div id="header-conteiner">
               ...
               <jsp:include page="Hat.jsp">
                            ...
                            <jsp:param name="parant" value="ListOfProducts.jsp"/>
           ...
           <div id="big_contain">
            <div class="for_inline">
                <div id="shopfilter">
                    ...
                    <ul class="menu-list" id="left-navigation">
                        <li class="left-navigation-item">
                            <a class="left-link" href="http://localhost:8084/Febos2/ListOfProducts.jsp?lang=<%=lang%>&direction=<%=idirection%>"><%=res.getString("left-navigation-item_"+0)%></a>
                        </li>
                    <%for(int i=1;res.containsKey("left-navigation-item_"+i); i++)
                    {%>
                        <li class="left-navigation-item">
                            <a class="left-link" href="http://localhost:8084/Febos2/ListOfProducts.jsp?lang=<%=lang%>&genre_filter=<%=resEn.getString("left-navigation-item_"+i)%>&direction=<%=idirection%>"><%=res.getString("left-navigation-item_"+i)%></a>
                        </li>
                    <%}%>
                    </ul>
                </div>
                ...
                <a href="http://localhost:8084/Febos2/Product.jsp?lang=<%=lang%>&id=<%=art.get(j).getId()%>">
                    <div class="product grid-item">
                    <jsp:include page="ProductMini.jsp">
                            <jsp:param name="lang" value="<%=lang%>"/>
                        ...
                        <span class="button_next" onclick=""><%=res.getString("buy")%></span>
                    </div> 
                </a>       
                    <%}}}
