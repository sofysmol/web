...
<c:set var="active_page" value="Cart.jsp" scope="session" />
                ...
                <div id="shopfilter">
                    ...
                    <ul class="menu-list" id="left-navigation">
                        ...
                        <c:forEach var="i" begin="1" end="4">
                            <li class="left-navigation-item">
                                <a class="left-link" href="http://localhost:8084/Febos2/ListOfProducts.jsp?lang=${lang}&genre_filter=<fmt:message bundle="${en}" key="left-navigation-item_${i}"/>"><fmt:message key="left-navigation-item_${i}" /></a>
                        </li>
                        </c:forEach>
                        </ul>
                </div>
                                        ...
                                        <c:forEach var="item" items="${order.getItemList()}">
                                            <fmt:parseNumber var="id" type="number" value="${item.getId()}"/>
                                               <%-- <c:set var="indexFile" value="${id/100}"/>
                                                ...
                                                <c:import url="ProductMini.jsp?lang=${lang}&name=${art.name}&author=${art.author}&path=${art.pathartwork}&price=${art.price}"/>   
