        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(request.getRemoteUser()!=null)
           {
            ...
            sb.append("<!DOCTYPE html>"
                    ...
                    + "<link rel=\"stylesheet\" type=\"text/css\" href=\"style/Hat.css\">"
                    ...
                    if(!user)
                    {
                           sb.append( "<a href=\"Profile.jsp?lang="+lang+"\"><span>"+res.getString("header_0")+"</span></a>/");
                           sb.append("<a href=\"Authorization.jsp?lang="+lang+"\"><span>"+res.getString("header_3")+"</span></a>");
                           sb.append("<a href=\"Cart.jsp?lang="+lang+"\"><span>"+ res.getString("header_1")+"</span></a> ");
                    }
                    else 
                            {
                                
                                sb.append(res.getString("header_2")+"<a href=\"Profile.jsp\"><span>"+request.getRemoteUser()+"</span></a><br>");
                                sb.append("<a href=\"Cart.jsp?lang="+lang+"\"><span>"+ res.getString("header_1")+"</span></a> ");
                        ...
                        sb.append("<div>"
                            +"<form  id=\"form_lang\" name=\"lang_form\" action=\"ProductServlet\" method=\"get\">" 
...
"                             <a class=\"navigerion-bar-link\" href=\"ListOfProducts.jsp?lang="+lang+"\">" +
...
"                            <a class=\"left-link\" href=\"http://localhost:8084/Febos2/ListOfProducts.jsp?lang="+lang+"\">"+res.getString("left-navigation-item_"+0)+"</a>\n" +
"                        </li>");
            for(int i=1;res.containsKey("left-navigation-item_"+i); i++)
                sb.append("<li class=\"left-navigation-item\">"
                    +"<a class=\"left-link\" href=\"http://localhost:8084/Febos2/ListOfProducts.jsp?lang="+lang+"&genre_filter="+resEn.getString("left-navigation-item_"+i)+"\">"+res.getString("left-navigation-item_"+i)+"</a></li>");
            sb.append("</ul></div>"
